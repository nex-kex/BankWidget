...
@pytest.mark.parametrize("currency, expected_list", [("RUB", [
    {
        "id": 873106923,
        "state": "EXECUTED",
...
@pytest.mark.parametrize("start, finish, expected_list",
                         [(6, 11, ["0000 0000 0000 0006", "0000 0000 0000 0007",
                                   "0000 0000 0000 0008", "0000 0000 0000 0009",
